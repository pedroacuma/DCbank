<%-- 
    Document   : retirarDinero
    Created on : 06-may-2018, 15:41:45
    Author     : Daniel
--%>
...
<%
    ...
    String error = (String)session.getAttribute("errorRetirar");
    if(error == null){
        error="";
    }
...
<html>
    ...
    <body>
        ...
        <h2 align="left"> Retirar Dinero: </h2>

        <div  class="registerform cf">
          <form  name="retirarDineroServlet" action="retirarDineroServlet" method="post">
            <ul>
		<li>
		...
		<li>
		<label for="importe"> Importe a Retirar</label>
